...
<h2>Employee View</h2>
  ...
  export default {
    ...
    methods: {
           StudentLoad()
           {
                 var page = "http://127.0.0.1:8001/api/student";
                 axios.get(page)
                  .then(
                      ({data})=>{
                        console.log(data);
           ...
           saveData()
           {
            axios.post("http://127.0.0.1:8001/api/student", this.student)
            .then(
              ({data})=>{
           ...
           updateData()
           {
              var editrecords = 'http://127.0.0.1:8001/api/student/'+ this.student.id;
           ...
           remove(student){
             ...
             var url = `http://127.0.0.1:8001/api/student/${student.id}`;
